(function(){
  ...
  function css(){
    ...
    style.textContent = `
      ...
      @media(max-width:640px){.vciom-card{padding:18px}.vciom-title{display:block}.vciom-kpis,.vciom-age{grid-template-columns:1fr}.vciom-row{grid-template-columns:1fr}.vciom-row div:not(:first-child){text-align:left}.vciom-chart{overflow-x:auto}.vciom-chart svg{min-width:620px}}
    `;
