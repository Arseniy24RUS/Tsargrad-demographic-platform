...
- Версия: 3.3.1
- Лицензия: MIT
- Назначение: графики на страницах СКР, расселения, усадьбы, маткапитала, ипотеки, выплат, семьи и абортов.
...
Страницы `Семья` и `Аборты` используют уже локально поставляемый Plotly из `docs/assets/vendor/plotly/plotly.min.js`; новых внешних runtime-библиотек, CDN или удалённых шрифтов они не добавляют.
