...
{
  "metadata": {
    "title": "Браки: браки, разводы и семейная устойчивость",
    "horizon": "1990–2023",
...
Для федерального ряда обязательная контрольная точка: 2010 год, `divorces_count = 639321`, `divorces_per_100_marriages ≈ 52.6162`.

## `docs/data/family_subjects.geojson`

GeoJSON субъектов РФ с добавленными последними значениями показателей модуля «Браки». Используется только для картограммы субъектов.
